...
public class game3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra("marksL2")) {
            marksall = intent.getIntExtra("marksL2", 0);
        }
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                confirmPlay = true;
                showquestions();
                audio.playAudio(game3.this,R.raw.clickbtn);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() { // onclick listener for back button
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(game3.this, home.class);
                audio.playAudio(game3.this,R.raw.clickbtn);
    ...
    private void showquestions() {
        ...
        if (currentQuestion <= totalQuestions) {
            ...
            Intent intent = new Intent(game3.this, endscreen.class);
            intent.putExtra("marksL3",marksall);
            startActivity(intent);
            audio.stopBackgroundMusic(game3.this);
        }
    ...
    private void checkAnswer(boolean isCorrect, int answer) {
        ...
        if (isCorrect) {
            ...
            audio.playAudio(game3.this, R.raw.correct);
            ...
            audio.playAudio(game3.this, R.raw.wrong);
            ans.setText(String.valueOf(answer));
        }
    ...
    public void setleveldescription(int level){
        ...
        description.setText("3 Second Time Limit");
